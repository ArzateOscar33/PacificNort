...
class Operaciones_maritimas_documentos extends Controller
{
    ...
    public function registrar()
    {
        ...
        try {
            ...
            $baseDocsAbs = $this->getDocsBaseDirAbs(); // <project_root>/Documents/DocumentosOperacion
            ...
            // ====== CAMBIO CLAVE: ruta relativa para BD (portable)
            $rutaRel = 'Documents/DocumentosOperacion/' . $opFolder . '/' . $ctFolder . '/' . $fileName;
    ...
    {
        $root = $this->getProjectRootPath();
        return $root . DIRECTORY_SEPARATOR . 'Documents' . DIRECTORY_SEPARATOR . 'DocumentosOperacion';
    }
}
