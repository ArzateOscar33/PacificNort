    ...
    public function registrar()
    {
        ...
        if ($id === '') {
            ...
            if ($this->model->existeCorreo($correo)) {
                echo json_encode(['status' => 'warning', 'msg' => 'Ya existe un cliente con ese correo']);
                die();
            }
            ...
            echo json_encode(['status' => 'success', 'msg' => 'Cliente registrado correctamente']);
            die();
        } else {
            // EDICIÓN
            if ($this->model->existeCorreoOtro($correo, $id)) {
                echo json_encode(['status' => 'warning', 'msg' => 'Otro cliente ya usa ese correo']);
                die();
            }
            ...
            echo json_encode(['status' => 'success', 'msg' => 'Cliente actualizado correctamente']);
            die();
        }
    }
