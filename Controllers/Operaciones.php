...
class Operaciones extends Controller
{
    ...
    public function ver($id)
    {
        ...
        $this->views->getView('admin/operaciones', "ver", $data);
    }
    // TAB : Crear Operación
    public function crear_operacion($id)
    {
        $data['title'] = 'Crear Operación';
        $this->views->getView('admin/operaciones/tabs/operaciones', "crear_operacion", $data);
    }
    ...
    public function detalles($id)
    {
        ...
        $data['title'] = 'Detalles Operacion';
        $this->views->getView('admin/operaciones/tabs/detalles_generales', "detalles", $data);
    ...
    public function contenedores($id)
    {
        ...
        $this->views->getView('admin/operaciones/tabs/contenedores', "contenedores", $data);
    ...
    {   
        ...
        $this->views->getView('admin/operaciones/tabs/costos', "costos", $data);
    }
    ...
    public function trazabilidad($id)
    {
        ...
        $this->views->getView('admin/operaciones/tabs/trazabilidad', "trazabilidad", $data);
    }
    ...
    public function documentos($id)
    {
        ...
        $this->views->getView('admin/operaciones/tabs/documentos', "documentos", $data);
 
    }
    public function costos_operacion($id)
    {
        $data['title'] = 'Costos por Operación';
        $this->views->getView('admin/operaciones/tabs/costos_operacion', "costos", $data);
    }
    ...
    public function log($id)
    {
        ...
        $data['title'] = 'Bitácora';
        $this->views->getView('admin/operaciones/tabs/log', "log", $data);
    }
    ...
    public function detalles_logisticos($id)
    {
        ...
        $this->views->getView('admin/operaciones/tabs/detalles_logisticos', "detalles_logisticos", $data);
    }
}
?>
