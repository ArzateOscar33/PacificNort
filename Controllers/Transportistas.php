...
class Transportistas extends Controller
{
    ...
    public function registrar()
    {
        ...
        if (!$nuevoId) {
            echo json_encode(['status' => 'error', 'msg' => 'No se pudo registrar el transportista']); die();
        }

        echo json_encode(['status' => 'success', 'msg' => 'Transportista registrado correctamente']); die();
    }
    ...
    public function actualizar()
    {
        ...
        if (!$ok) {
            echo json_encode(['status' => 'error', 'msg' => 'No se pudo actualizar el transportista']); die();
        }

        echo json_encode(['status' => 'success', 'msg' => 'Transportista actualizado correctamente']); die();
    }
    ...
    public function eliminar($id)
    {
        ...
        if ($ok) {
            echo json_encode(['status' => 'success', 'msg' => 'Transportista desactivado correctamente']); die();
        }
        echo json_encode(['status' => 'error', 'msg' => 'No se pudo desactivar el transportista']); die();
    }
