...
class Navieras extends Controller
{
    ...
    public function registrar()
    {
        ...
        if (!$nuevoId) {
            echo json_encode(['status' => 'error', 'msg' => 'No se pudo registrar la naviera']);
            die();
        }

        echo json_encode(['status' => 'success', 'msg' => 'Naviera registrada correctamente']);
        die();
    }
    ...
    public function actualizar()
    {
        ...
        if (!$ok) {
            echo json_encode(['status' => 'error', 'msg' => 'No se pudo actualizar la naviera']);
            die();
        }

        echo json_encode(['status' => 'success', 'msg' => 'Naviera actualizada correctamente']);
        die();
    }
    ...
    public function eliminar($id)
    {
        ...
        if ($ok) {
            echo json_encode(['status' => 'success', 'msg' => 'Naviera desactivada correctamente']);
            die();
        }
        echo json_encode(['status' => 'error', 'msg' => 'No se pudo desactivar la naviera']);
        die();
    }
