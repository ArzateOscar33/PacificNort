...
public function listarCostosCombinadosPaginado(array $filters = [], int $page = 1, int $per_page = 10): array
{
    ...
    // term: concepto / comentario / cliente
    if ($term !== '') {
        $whereExtra .= " AND (
    ...
    $unionSql = "
        SELECT
            ...
            CONCAT('MAR: ', o.numero_operacion) AS operacion_origen,
        ...
        SELECT
            ...
            CONCAT('FO: ', ofe.numero_operacion) AS operacion_origen,
