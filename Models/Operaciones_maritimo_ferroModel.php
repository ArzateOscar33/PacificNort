...
class Operaciones_maritimo_ferroModel extends Query
{
    ...
    public function listarPaginado(array $filters = [], int $page = 1, int $perPage = 10): array
    {
        ...
        // OJO: este filtro NO vive en operaciones directamente, vive en contenedores.
        // Como tú ya traes un agregado "cont.tipo_contenedor", puedes filtrar con EXISTS para no romper el fan-out.
