...
class Operaciones_maritimo_ferro_eventosModel extends Query
{
    ...
    public function listar()
    {
        ...
        ORDER BY e.fecha DESC, e.id_evento ASC
        ";
    ...
    {
        $sql = "SELECT `id_tipo_evento`,`nombre` FROM `tipos_evento_logistico` WHERE `id_tipo_operacion`=1  AND estatus=1 ORDER BY id_tipo_evento desc";
