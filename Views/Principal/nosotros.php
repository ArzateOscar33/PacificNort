  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <p class="section-subtitle text-center" data-aos="fade-up" data-aos-delay="100">
          Somos una empresa mexicana especializada en brindar asesoría y servicios de logística internacional,
          garantizando eficacia y cumplimiento en cada etapa del proceso.
        </p>
      </div>
    </div>
    ...
    <div class="row mt-5">
      <div class="col-lg-10 mx-auto">
        ...
        </div> <!-- Cierra about-content -->
      </div> <!-- Cierra col-lg-10 -->
    </div> <!-- Cierra row mt-5 -->
