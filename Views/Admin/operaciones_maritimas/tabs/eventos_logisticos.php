    ...
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                ...
                Eventos Logísticos (Marítimo)
            </h5>
            <button class="btn btn-light btn-sm"
                    data-bs-toggle="modal"
                    data-bs-target="#modalDetallesLogisticos"
        ...
        <div class="card-body">
                ...
                <div class="col-md-8">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="text"
                               ...
                               class="form-control"
                               placeholder="Escribe para buscar (ej. LBMF-06)"
                               autocomplete="off">
                        <div id="eventosFiltroOpSugerencias"
                             class="list-group"
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle" id="tablaEventosMar">
                    ...
                    <tr id="theadDetallesLogisticos" class="text-center">
                        <!-- Fijos -->
        ...
        <div class="modal-content">
            ...
            <form id="formEventosLogisticos" autocomplete="off">
                <div class="modal-body">
                    ...
                    <!-- Para operaciones marítimas, dejamos fijo el tipo M -->
                    <input type="hidden" id="eventoContenedorTipo" name="eventoContenedorTipo" value="M">
                    ...
                    <div class="row g-3 mb-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                ...
                                <input type="text"
                                       id="eventoOperacionNombre"
                                       class="form-control"
                                       placeholder="Escribe para buscar (ej. JL-05)"
                                       autocomplete="off"
                                       required>
                                <div id="eventoOperacionSugerencias"
                                     class="list-group"
                                     style="position:absolute; z-index:1061; width:100%; display:none;"></div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                ...
                                <input type="text"
                                       id="eventoContenedorNombre"
                                       class="form-control"
                                       placeholder="Escribe para buscar (ej. EMCU…, MSKU…, TEXU…)"
                                       autocomplete="off"
                                       readonly>
                                <div id="eventoContenedorSugerencias"
                                     class="list-group"
                                     style="position:absolute; z-index:1061; width:100%; display:none;"></div>
                            </div>
                            <div class="form-text">
                                Se listan los contenedores marítimos de la operación seleccionada.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date"
                                   class="form-control"
                                   id="fechaEventoLogistico"
                                   name="fechaEventoLogistico"
                                   required>
                        </div>
                        <div class="col-md-4">
                            <label for="comentarioEventoLogistico" class="form-label">Comentarios</label>
                            <input type="text"
                                   id="comentarioEventoLogistico"
                                   name="comentarioEventoLogistico"
                                   class="form-control"
...
<!-- Modal de celda (igual que en el módulo correcto) -->
