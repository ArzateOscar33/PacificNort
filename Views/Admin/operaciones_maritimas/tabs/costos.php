          ...
          <div class="mb-3">
            <div class="position-relative">
              ...
              <div class="mb-3">
                ...
                <select id="costosContenedoresTipoCosto" name="costosContenedoresTipoCosto" class="form-control"
                  required>
              ...
              <div class="mb-3">
                ...
                <select id="costosContenedoresMoneda" name="costosContenedoresMoneda" class="form-control" readonly>
