      ...
      <form id="formCostoOperacion">
        <div class="modal-body">
          ...
          <div class="mb-3 position-relative">
            ...
            <input type="text" id="costosOperacionOpNombre" class="form-control" placeholder="Escribe para buscar…" autocomplete="off">
            <div id="costosOperacionOpSugerencias" class="list-group" style="position:absolute; z-index:1061; width:100%; display:none;"></div>
          ...
          <div class="row g-2">
            <div class="col-6">
              ...
              <input type="number" step="0.01" id="costosOperacionMonto" name="monto" class="form-control" required placeholder="Ej: 150">
            </div>
            <div class="col-6">
