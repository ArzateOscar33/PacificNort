...
<div class="row g-2 align-items-center mb-3">
  ...
  <div class="col-12 col-lg-10 position-relative">
    <input type="text" class="form-control" id="buscarContenedorFisico" name="buscarContenedorFisico"
           placeholder="Buscar Contenedor Físico" autocomplete="off">
    <div id="sugerenciasContenedorFisico"
  ...
  <div class="col-12 col-lg-2 d-flex justify-content-lg-end">
    <button id="btnAgregarContenedorFisico" class="btn btn-primary w-100 w-lg-auto"
...
<div class="modal fade" id="modalRegistrarContenedorFisico" data-bs-backdrop="static" data-bs-keyboard="false"
  tabindex="-1" aria-labelledby="modalRegistrarContenedorFisicoLabel" aria-hidden="true">
