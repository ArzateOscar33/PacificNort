         ...
         <table class="table table-bordered table-hover align-middle bg-white shadow-sm">
             ...
             <tbody>
                 <tr>
                     <td>admin</td>
                     <td>JL-46</td>
                     <td><span class="badge bg-success text-dark"><i data-feather="plus" class="me-1"></i>Insertar</span></td>
                 ...
                 <tr>
                     <td>karla</td>
                     <td>JL-61</td>
                     <td><span class="badge bg-danger text-dark"><i data-feather="trash-2" class="me-1"></i>Eliminar</span></td>
