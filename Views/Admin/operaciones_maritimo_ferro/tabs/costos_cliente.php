    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            ...
            <div class="d-flex flex-wrap gap-3 justify-content-between align-items-end mb-3">
                <div>
                    <h3 class="mb-1">Costos Totales</h3>
                    <small class="text-muted">
                        Consulta todos los costos totales por operación .
                    </small>
                </div>

            </div>
            <div class="d-flex col-md-12 col-12 gap-2 justify-content-end align-items-end">
                <div class="  d-flex gap-2 justify-content-end align-items-end col-md-4">
            ...
            <div class="row g-2 align-items-end mb-3">
                ...
                <div class="col-12 col-md-12 row">
                    ...
                    <!-- Transportista -->
                    <div class="col-12 col-md-2">
                        <label class="form-label mb-1">Transportista Maritimo</label>
                    ...
                    <div class="col-12 col-md-2">
                        <label class="form-label mb-1">Transportista Ferro/Caja</label>
                        <select id="transportistaFerroId_cc" name="transportistaFerroId_cc" class="form-control">
                            <option value="">Seleccione...</option>
                            <?php if (!empty($data['transportistas'])): ?>
                                <?php foreach ($data['transportistas'] as $t): ?>
                                    <option value="<?= (int)$t['id_transportista']; ?>">
